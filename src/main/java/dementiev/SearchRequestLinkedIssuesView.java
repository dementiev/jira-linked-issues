...
public class SearchRequestLinkedIssuesView extends AbstractSearchRequestIssueTableView {
    private static Logger log = Logger.getLogger(SearchRequestLinkedIssuesView.class);
    ...
    public void writeSearchResults(SearchRequest searchRequest, SearchRequestParams searchRequestParams, Writer writer) {
        ...
        try {
            ...
            final IssueTableWriter issueTableWriter = new LinkedIssueTableWebComponent().getHtmlIssueWriter(writer, columnLayout, null, null);
